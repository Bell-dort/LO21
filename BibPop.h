...
Population* creerPopulation(void);// Creer et initialiser un liste d'individus
Population* ajouterTPopulation(Population*, Individu*);
Population* ajouterQPopulation(Population*, Individu*);
...
Population* SelectPop(Population*, int);
